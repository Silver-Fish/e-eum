package com.ssafy.eeum.voice.dto.request;
...
@NoArgsConstructor
@Getter
@ApiModel(description = "음성 등록 모델")
public class VoiceInsertRequest {
    ...
    public VoiceInsertRequest(@NotBlank @Length(max = 10, message = "단어의 최대 길이는 10자입니다.") String word) {
        this.word = word;
    }
